...
namespace Common
{
    public class Main : IPlugin
    {
        ...
        public Format Get_Format(sFile file, byte[] magic)
        {
            ...
            if (file.name.ToUpper().EndsWith(".TGA") || file.name.ToUpper().EndsWith(".GIF") || file.name.ToUpper().EndsWith(".JPG") || file.name.ToUpper().EndsWith(".PNG") || file.name.ToUpper().EndsWith(".JPEG"))
